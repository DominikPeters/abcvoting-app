...
PROPERTY_NAMES = ["pareto", "jr", "pjr", "ejr", "ejr+", "fjr", "priceability", "stable-priceability", "core"]
...
def check(property_name, profile, committee, algorithm="fastest"):
    ...
    if property_name == "pareto":
        ...
        return check_FJR(profile, committee)
...
def check_EJR(profile, committee, algorithm="fastest"):
    ...
    if algorithm == "brute-force":
        ...
        result, detailed_information = _check_EJR_pulp(profile, committee)
    else:
...
def check_PJR(profile, committee, algorithm="fastest"):
    ...
    if algorithm == "brute-force":
        ...
        result, detailed_information = _check_PJR_pulp(profile, committee)
    else:
...
def check_core(profile, committee, algorithm="fastest", committeesize=None):
    ...
    if algorithm == "brute-force":
        ...
        result, detailed_information = _check_core_pulp(profile, committee, committeesize)
    else:
